...
public class QuartzifiedWorldEditor : EditorWindow
{
    ...
    {
        EditorWindow.GetWindow<QuartzifiedWorldEditor>("World Editor").Show();
    }
    ...
    void MainToolWindow()
    {
        EditorGUILayout.LabelField("Tool Select", TitleStyle(), GUILayout.Height(28));
        GUILayout.Space(24);
    ...
    {
        EditorGUILayout.LabelField("Object Spawning", TitleStyle(), GUILayout.Height(32));
        GUILayout.Space(24);

        EditorGUILayout.LabelField("Brush Settings", SectionStyle(), GUILayout.Height(32));
        ...
        EditorGUILayout.LabelField("Object Selection", SectionStyle(), GUILayout.Height(22));
        ...
        EditorGUILayout.LabelField("Inclusions / Exclusions", SectionStyle(), GUILayout.Height(22));
        ...
        EditorGUILayout.LabelField("Object Manipulation", SectionStyle(), GUILayout.Height(22));
    ...
    {
        EditorGUILayout.LabelField("Foliage Spawning", TitleStyle(), GUILayout.Height(28));
        GUILayout.Space(24);
    ...
    void EditToolWindow()
    {
        EditorGUILayout.LabelField("Edit Mode", TitleStyle(), GUILayout.Height(28));
        GUILayout.Space(24);
        ...
        if(foliageVar.foliagePlaced.Count > 0)
        {
            foreach(GameObject foliage in foliageVar.foliagePlaced)
            {
                if(foliage != null && foliageVar.justAddedFoliage != null)
                {
                    ...
                    {
                        if (GetHalfBoundsForGameObject(foliage).Intersects(GetBoundsForGameObject(foliageVar.justAddedFoliage)))
                        {
                    ...
                    {
                        if (GetHalfBoundsForGameObject(foliage).Intersects(GetHalfBoundsForGameObject(foliageVar.justAddedFoliage)))
                        {
                            DestroyImmediate(foliageVar.justAddedFoliage);
                            return;
                        }
                    ...
                    {
                        if (GetBoundsForGameObject(foliage).Intersects(GetBoundsForGameObject(foliageVar.justAddedFoliage)))
                        {
                            DestroyImmediate(foliageVar.justAddedFoliage);
                            return;
                        }
    ...
    void DropObjects(string method)
    {
        ...
        for (int i = 0; i < Selection.transforms.Length; i++)
        {
            ...
            Bounds bounds = GetBoundsForGameObject(go);
            savedLayer = go.layer;
            go.layer = 2;
    ...
    Bounds GetBoundsForGameObject(GameObject go)
    {
    ...
    Bounds GetHalfBoundsForGameObject(GameObject go)
    {
        Bounds bounds = new Bounds();
        bounds.center = go.transform.position;
        bounds.extents = Vector3.zero;
